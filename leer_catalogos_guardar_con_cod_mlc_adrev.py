...
def process_and_load_catalog(file_path, connection, nombre_cliente, tipo_cliente, fecha_recibido):
    ...
    for index, row in catalogo_df.iterrows():
        ...
        if codigo_mlc or codigo_adrev:
            insert_subidas_plataforma(connection, obra_id_actual, codigo_mlc, codigo_adrev)
...
if __name__ == "__main__":
    ...
    if connection:
        ...
        process_and_load_catalog('CATALOGO_SAYCO_CODIGOS_MLC.xlsx', connection, cliente_1['nombre'], cliente_1['tipo'], cliente_1['fecha_recibido'])
        process_and_load_catalog('CATALOGO_SAYCE_MLC_ADREV_CODE.xlsx', connection, cliente_2['nombre'], cliente_2['tipo'], cliente_2['fecha_recibido'])
