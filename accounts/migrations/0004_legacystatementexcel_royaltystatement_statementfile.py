    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["id_file"], name="legacy_stat_id_file_f55d8f_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "derecho",
                    models.CharField(
                        choices=[("Mecanico", "Mecanico"), ("MicroSync", "MicroSync")],
                        max_length=16,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["anio", "periodo_q"], name="royalty_sta_anio_6666b8_idx"
                    ),
                    models.Index(
                        fields=["obra_id"], name="royalty_sta_obra_id_e0df6e_idx"
                    ),
                    models.Index(
                        fields=["codigo_mlc"], name="royalty_sta_codigo__fb4732_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_type",
                    models.CharField(
                        choices=[("XLSX", "XLSX"), ("TSV", "TSV")], max_length=8
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["cliente", "anio", "periodo_q"],
                        name="statement_f_cliente_74a22a_idx",
                    )
                ],
            },
        ),
